...
function openCrosswordLink() {
    window.open('https://www.nine.com.au/crossword/2018/09/16');
}

function openPuzzleLink() {
    window.open('https://www.jigsawexplorer.com/');
}

function openCardgameLink() {
    window.open('https://cardgames.io/');
}